...
// Datatable (jquery)
$(function () {
var dt_user_table = $('.datatables-users')// Variable declarada para la tabla
...
$(document).on('click', '.pdf', function () {
  ...
  var num_dictamen = $(this).data('num-certificado');
