...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      serverSide: true,
      ajax: {
        url: baseUrl + 'BitacoraProductoMaduracion-list',
        data: function (d) {
...
$(document).ready(function () {
  ...
  $(document).on('click', '#verBitacoraBtn', function () {
    ...
    let urlPDF = `/BitacoraProductoMaduracionPDF?empresa=${empresaId}`;
    if (instalacionId) {
  ...
  $(document).on('click', '.delete-record', function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: 'DELETE',
          url: `${baseUrl}bitacoraProductoMaduracion-delete/${id_bitacora}`,
          headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          },
          success: function () {
  ...
  $(function () {
    ...
    const fv = FormValidation.formValidation(form, {
      ...
      $.ajax({
        url: '/bitacoraProductoMaduracionStore',
        type: 'POST',
        data: formData,
        success: function (response) {
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    $.ajax({
      url: '/bitacoraProductoMaduracion/' + bitacoraID + '/edit',
      method: 'GET',
      success: function (data) {
        if (data.success) {
  ...
  $(function () {
    ...
    const fv = FormValidation.formValidation(form, {
      ...
      $.ajax({
        url: '/bitacoraProductoMaduracionUpdate/' + id,
        type: 'POST',
        data: formData,
        success: function (response) {
  ...
  $(document).on('click', '.firma-record', function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: 'POST',
          url: `/FirmaProductoMaduracion/${id_bitacora_firma}`,
          headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          },
          success: function () {
