        ...
        },*/
        {
          ...
          let acciones = '';
            if (window.puedeEditarElUsuario) {
              acciones += `<a data-id="${full['id_categoria']}" data-bs-toggle="offcanvas" data-bs-target="#editLoteEnvasado" href="javascript:;" class="dropdown-item edit-record"><i class="ri-edit-box-line ri-20px text-info"></i> Editar categoria</a>`;
            }
            if (window.puedeEliminarElUsuario) {
              acciones += `<a data-id="${full['id_categoria']}" class="dropdown-item delete-record  waves-effect text-danger"><i class="ri-delete-bin-7-line ri-20px text-danger"></i> Eliminar categoria</a>`;
            }
