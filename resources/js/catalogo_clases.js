...

        {
          ...
          let acciones = '';
            ...
            if (window.puedeEliminarElUsuario) {
              acciones += `<a data-id="${full['id_clase']}" class="dropdown-item delete-record  waves-effect text-danger"><i class="ri-delete-bin-7-line ri-20px text-danger"></i> Eliminar catalago clase</a>`;
            }
