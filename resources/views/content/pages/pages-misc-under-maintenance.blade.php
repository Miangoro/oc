...
@section('content')
    ...
    <div class="misc-wrapper">
        <div class="content-wrapper">
            <h4 class="mb-2 mx-2 glow">Página bajo mantenimiento! 🚧</h4>
            <p class="mb-6 mx-sm-2 text-center">Disculpe las molestias pero estamos realizando algunas tareas de
                mantenimiento en este momento.</p>
            <div class="d-flex justify-content-center">
                ...
                <div class="d-flex flex-column align-items-center">
                    <img src="{{ asset('assets/img/illustrations/logo_mantenimiento.png') }}" alt="misc-error"
