    ...
    <div class="modal-dialog modal-lg modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="loteForm" method="POST" action="{{ route('lotes-granel.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="text" id="nombre_lote" name="nombre_lote" class="form-control" placeholder="Nombre del lote" required />
                    ...
                    <div id="oc_cidam_fields" class="d-none">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" id="no_analisis" name="no_analisis" class="form-control" placeholder="No. de Análisis Fisicoquímico" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="file" id="analisis_fisicoquimico" name="analisis_fisicoquimico" class="form-control" />
                                    <label for="analisis_fisicoquimico">Adjuntar Análisis Fisicoquímico</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="number" step="0.01" id="volumen_lote" name="volumen_lote" class="form-control" placeholder="Volumen de Lote Inicial (litros)" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="number" step="0.01" id="contenido_alcoholico" name="contenido_alcoholico" class="form-control" placeholder="Contenido Alcohólico" />
                    ...
                    <div id="otro_organismo_fields" class="d-none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="folio_certificado" name="folio_certificado" class="form-control" placeholder="Folio/Número de Certificado" />
                                    <label for="folio_certificado">Folio/Número de Certificado</label>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="form-floating form-floating-outline">
                                    <select id="organismo_certificacion" name="organismo_certificacion" class="select2 form-select" >
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="date" id="fecha_emision" name="fecha_emision" class="form-control datepicker" placeholder="Fecha de Emisión" />
                                    <label for="fecha_emision">Fecha de Emisión</label>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="date" id="fecha_vigencia" name="fecha_vigencia" class="form-control datepicker" placeholder="Fecha de Vigencia" />
