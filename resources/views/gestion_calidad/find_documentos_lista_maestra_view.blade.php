...
@section('page-script')
    ...
    @vite(['resources/js/documentos_lista_maestra.js'])
@endsection
 ...
 --}}
    ...
    <div class="card">
        <div class="card-header pb-0">
            <h3 class="card-title mb-0">Lista maestra</h3>
        </div>
    ...
    @include('_partials/_modals/modal_add_documentos_lista_maestra')
    {{-- @include('_partials/_modals/modal_edit_documentos_lista_maestra') --}}
    <!-- /Modal -->
@endsection
