...
@section('page-script')
    ...
    @vite(['resources/js/documentos_registro.js'])
@endsection
...
@section('content')
 ...
 --}}
    ...
    @include('_partials/_modals/modal_add_documentos_registro')
    @include('_partials/_modals/modal_edit_documentos_registro')
    <!-- /Modal -->
@endsection
