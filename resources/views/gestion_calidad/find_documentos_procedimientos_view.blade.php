...
@section('page-script')
    ...
    @vite(['resources/js/documentos_procedimientos.js'])
@endsection
 ...
 --}}
    ...
    <div class="card">
        <div class="card-header pb-0">
            <h3 class="card-title mb-0">Procedimientos</h3>
        </div>
    ...
    @include('_partials/_modals/modal_add_documentos_procedimientos')
    @include('_partials/_modals/modal_edit_documentos_procedimientos')
    <!-- /Modal -->
@endsection
