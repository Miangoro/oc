...
@section('title', 'Manuales, Políticas, Organigrama y otros')
...
@section('page-script')
    ...
    @vite(['resources/js/documentos_manuales.js'])
@endsection
 ...
 --}}
    ...
    <div class="card">
        <div class="card-header pb-0">
            <h3 class="card-title mb-0">Manuales, políticas, organigrama y otros</h3>
        </div>
    ...
    @include('_partials/_modals/modal_add_documentos_manuales')
    @include('_partials/_modals/modal_edit_documentos_manuales')
    <!-- /Modal -->
@endsection
