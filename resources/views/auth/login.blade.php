                ...
                <div class="w-100 mx-auto">
                    ...
                    <form id="formAuthentication-mobile" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @error('email') is-invalid @enderror" id="login-email-mobile"
                        ...
                        <div class="form-password-toggle">
                            <div class="input-group">
                                <div class="form-floating">
                                    <input type="password" id="login-password-mobile" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Contraseña">
