            ...
            <div class="offcanvas-body mx-0 flex-grow-0 h-100">
                <form class="add-new-user pt-0" id="addNewUserForm">
                    ...
                    <div class="form-floating form-floating-outline mb-5">
                        <input type="text" class="form-control" id="add-user-fullname" placeholder="Ana Gómez"
                            name="name" aria-label="Ana Gómez" />
                        <label for="add-user-fullname">Nombre completo</label>
                    </div>
                    <div class="form-floating form-floating-outline mb-5">
                        <input type="text" id="add-user-email" class="form-control" placeholder="ana.gmz@example.com"
                            aria-label="ana.gmz@example.com" name="email" />
                        <label for="add-user-email">Correo</label>
                    </div>
                    <div class="form-floating form-floating-outline mb-5">
                        <input id="add-user-tel" type="tel" class="form-control" placeholder="Teléfono" aria-label=""
                            name="telefono" />
                    ...
                    <div class="form-floating form-floating-outline mb-5">
                        <select id="id_contacto" name="id_contacto" data-placeholder="Selecciona una persona de contacto"
                    ...
                    <div class="form-floating form-floating-outline mb-5">
                        <select id="rol_id" name="rol_id" data-placeholder="Selecciona un rol"
                            class="select2 form-select" aria-label="Default select example">
