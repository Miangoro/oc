...
@section('page-script')
<script>
  window.puedeAgregarElUsuario = @json(auth()->user()->can('Registrar revisión UI'));
  window.puedeEditarElUsuario = @json(auth()->user()->can('Editar revisión UI'));
