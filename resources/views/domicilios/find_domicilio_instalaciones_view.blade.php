...
<div class="card">
    ...
    <!-- Offcanvas para agregar nueva instalación -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddInstalacion" aria-labelledby="offcanvasAddInstalacionLabel">
      <div class="offcanvas-header border-bottom">
        <h5 id="offcanvasAddInstalacionLabel" class="offcanvas-title">Nueva Instalación</h5>
...
<!-- CSS para ajustar el tamaño y la posición del offcanvas -->
<style>
.offcanvas-end {
    width: 50%; /* Ajusta el ancho del offcanvas */a
    height: 100%; /* Ajusta la altura del offcanvas para ocupar toda la altura de la pantalla */
    top: 0; /* Alinea el offcanvas al top de la pantalla */
    transform: none; /* Elimina la transformación vertical centrada */
}
</style>
