            ...
            <div class="modal-body p-0">
                ...
                <form id="NuevoCertificadoExport">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-floating form-floating-outline mb-6">
                                <select class="form-select select2" name="id_dictamen" data-placeholder="Seleccione el número de dictamen">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline mb-6">
                                <input type="date" class="form-control datepicker" name="fecha_vigencia" readonly />
            ...
            <div class="modal-body p-0">
                ...
                <form id="EditarCertificadoExport">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating form-floating-outline mb-6">
                                <select id="edit_id_dictamen" name="id_dictamen" class="form-select select2" >
                                    @foreach ($dictamen as $dic)
                                        <option value="{{ $dic->id_dictamen }}">{{ $dic->num_dictamen }} | </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline mb-4">
                                <select class="select2 form-select" id="edit_id_firmante" name="id_firmante">
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}">{{ $user->name }}</option>
                                    @endforeach
                                </select>
