<!-- MODAL AGREGAR -->
<div class="modal fade" id="ModalAddSoli052DictaminacionInstalacion" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary pb-4">
                <h5 class="modal-title text-white">Nueva solicitud 052 - Dictaminación de instalaciones</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-8">
                <form id="FormAddSoli052DictaminacionInstalacion">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
