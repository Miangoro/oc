    ...
    <div class="modal-dialog modal-lz">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary pb-4">
                <h5 class="modal-title text-white">Reexpedir/Cancelar dictamen de envasado</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <form id="FormReexpedir" method="POST" action="{{ route('dic-envasado.reex') }}">
                    <div class="row mb-4">
                        <input type="hidden" id="rex_id_dictamen" name="id_dictamen_envasado">
