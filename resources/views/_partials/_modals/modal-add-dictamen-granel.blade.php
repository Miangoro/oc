    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="modalAddDictamenGranelLabel" class="modal-title">Nuevo Dictamen de Granel</h5>
            ...
            <div class="modal-body">
                <form id="addNewDictamenGranelForm" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline">
                                <input class="form-control datepicker" id="fecha_emision" name="fecha_emision"
                        ...
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline">
                                <input class="form-control datepicker" id="fecha_vigencia" name="fecha_vigencia"
                                    placeholder="yyyy-mm-dd">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline">
                                <input class="form-control datepicker" id="fecha_servicio" name="fecha_servicio"
                                    placeholder="yyyy-mm-dd">
