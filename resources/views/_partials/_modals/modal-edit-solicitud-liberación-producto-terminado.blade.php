<div class="modal fade" id="editLiberacionProducto" tabindex="-1">
  <div class="modal-dialog modal-xl modal-simple modal-edit-new-liberacion">
      <div class="modal-content">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          <div class="modal-body p-0">
              <div class="text-center mb-6">
                  <h4 class="address-title mb-2">Editar Liberación de producto terminado nacional</h4>
              ...
              <form id="editLiberacionProductoForm">
                  <div class="row">
                      <div class="col-md-6">
                        ...
                        <input type="hidden" name="form_type" value="LiberacionProductoTerminado">
                          <div class="form-floating form-floating-outline mb-6">
                              <select id="edit_id_empresa_solicitud_lib_ter" onchange="editObtenerInstalacion_lib_ter();"
                      ...
                      <div class="col-md-6">
                          <div class="form-floating form-floating-outline mb-5">
                              <input id="edit_fecha_liberacion_terminado" placeholder="YYYY-MM-DD" class="form-control flatpickr-datetime" type="text"
                                  name="fecha_visita" />
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="form-floating form-floating-outline mb-6 input-group ">
                              <select class=" form-select" id="edit_id_instalacion_lib_ter" name="id_instalacion"
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                          <div class="form-floating form-floating-outline mb-4">
                              <input type="number" id="edit_hologramas_utilizados_lib_ter" name="hologramas_utilizados"
