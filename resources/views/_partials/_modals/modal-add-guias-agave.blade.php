...
<div class="modal fade" id="editGuias" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary pb-4">
                <h5 class="modal-title text-white">Llenar solicitud de Guía de traslado Agave/Maguey</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <p class="address-subtitle"></p>
            </div>
            ...
            <form id="editGuiaForm" method="POST" enctype="multipart/form-data" onsubmit="return false">
                ...
                <div class="row">
                    ...
                    <div class="form-floating form-floating-outline mb-6">
                        <select class="select2 form-select" id="edit_nombre_predio" name="predios" aria-label="Predio" required disabled>
                ...
                <div class="col-12 mt-6 d-flex flex-wrap justify-content-center gap-4 row-gap-4">
                    <button type="submit" class="btn btn-primary"><i class="ri-pencil-fill"></i> Actualizar</button>
...
<script>//editar
    ...
    //FUNCION PARA REGRESAR A GUIAS GENERALES (ver guías)
    document.addEventListener("DOMContentLoaded", function() {
        // Selecciona los botones por su id
        const closeModalButtons = [document.getElementById("btnCancelModal")];
