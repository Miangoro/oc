      ...
      <div class="modal-content">
          ...
          <div class="modal-body p-0">
              <div class="text-center mb-6">
                  <h4 class="address-title mb-2">Editar solicitud de muestreo de agave</h4>
                    ...
                    <input type="hidden" name="form_type" value="muestreoagave">
                      <div class="col-md-6">
                          <div class="form-floating form-floating-outline mb-6">
                              <select onchange="obtenerInstalacionesMuestreoAgaves(); obtenerlasguiass();" id="id_empresa_muestr" name="id_empresa"
                      ...
                      <div class="col-md-6">
                          <div class="form-floating form-floating-outline mb-5">
                              <input placeholder="YYYY-MM-DD" class="form-control flatpickr-datetime" id="fecha_visita_muestr" type="text"
                                  name="fecha_visita" />
