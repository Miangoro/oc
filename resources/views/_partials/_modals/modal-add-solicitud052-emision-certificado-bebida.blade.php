<!-- MODAL AGREGAR -->
<div class="modal fade" id="ModalAddSoli052EmisionCertificadoBebida" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary pb-4">
                <h5 class="modal-title text-white">Nueva solicitud 052 - Emisión de certificado de cumplimiento de la bebida
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-8">
                <form id="FormAddSoli052EmisionCertificadoBebida">
                    <div class="row">
                        <div class="col-md-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="text" id="cont_alc" name="cont_alc" class="form-control"
                                    required>
                                <label>%Alc. Vol</label>
                            </div>
                        </div>
