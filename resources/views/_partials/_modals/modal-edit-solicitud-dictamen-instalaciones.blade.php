      ...
      <div class="modal-content">
          ...
          <div class="modal-body p-0">
              ...
              <form id="addEditSolicitud">
                  <div class="row">
                      <div class="col-md-6">
                        ...
                        <input type="hidden" name="form_type" value="dictaminacion">
                          <div class="form-floating form-floating-outline mb-6">
                              <select id="edit_id_empresa" onchange="obtenerInstalaciones();"
                      ...
                      <div class="col-md-6">
                          <div class="form-floating form-floating-outline mb-5">
                              <input placeholder="YYYY-MM-DD" class="form-control flatpickr-datetime" type="text" id="edit_fecha_visita" name="fecha_visita" />
                  ...
                  <div class="row">
                      <div class="form-floating form-floating-outline mb-5">
                          <textarea  id="edit_info_adicional" name="info_adicional" class="form-control h-px-150" placeholder="Información adicional sobre la actividad..."></textarea>
