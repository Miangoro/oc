                ...
                <form id="addInspeccionLiberacionForm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline mb-5">
                                <input placeholder="YYYY-MM-DD" class="form-control datepicker"
                                    type="date" id="fecha_inicio_lib" name="fecha_inicio_lib" readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline mb-5">
                                <input placeholder="YYYY-MM-DD" class="form-control datepicker"
                                    type="date" id="fecha_termino_lib" name="fecha_termino_lib" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline mb-5">
                                <input type="text" class="form-control" id="material_liberacion" name="material_liberacion"
                        ...
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline mb-5">
                                <input type="text" class="form-control" id="capacidad" name="capacidad_liberacion"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline mb-5">
                                <input type="text" class="form-control" id="tiempo_dura_lib" name="tiempo_dura_lib"
