            ...
            <div class="modal-body p-0">
                ...
                <form id="addInspeccionEnvasadoForm">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline mb-5">
                                <input type="text" class="form-control bg-light text-muted" id="id_categoria_inspeccion"
                                    name="id_categoria_inspeccion" placeholder="Ingresa una Categoria" readonly
