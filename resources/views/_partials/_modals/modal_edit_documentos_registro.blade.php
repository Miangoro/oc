           ...
           <div class="modal-dialog modal-xl">
               <div class="modal-content">
                   ...
                   <div class="modal-header bg-primary pb-4">
                       <h5 class="modal-title text-white" id="modalAddDocLabel">Historial</h5>
       ...
       <div class="modal fade" id="modalEditHistorial" tabindex="-1" aria-labelledby="modalEditHistorialLabel"
           ...
           <div class="modal-dialog modal-xl">
               <div class="modal-content">
                   ...
                   <!-- Header -->
                   <div class="modal-header bg-primary pb-4">
                       <h5 class="modal-title text-white" id="modalEditHistorialLabel">Registrar documentos</h5>
                       <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                   </div>
                       ...
                       <form id="formEditHistorial" enctype="multipart/form-data">
                           ...
                           <div class="card-body">
                               <div class="row g-3">
                                   ...
                                   <div class="col-md-6">
                                       <div class="form-floating form-floating-outline">
                                           <select name="id_procedimiento" id="edit_id_procedimiento" class="select2 form-select">
                                               <option value="">Seleccione un procedimiento</option>
                                               @foreach ($procedimientos as $procedimiento)
                                                   <option value="{{ $procedimiento->id_doc_calidad }}">
                                                       {{ $procedimiento->identificacion }} -
                                                       {{ $procedimiento->nombre }}
                                                   </option>
                                               @endforeach
                                           </select>
                                           <label for="procedimiento">Procedimiento (Al que pertenece)</label>
                                       </div>
                                   </div>
                                   <!-- Archivo -->
                                   <div class="col-md-6">
       ...
       <div class="modal fade" id="modalEditHistorialEdit" tabindex="-1" aria-labelledby="modalEditHistorialEditLabel"
           ...
           <div class="modal-dialog modal-xl">
               <div class="modal-content">
                   ...
                   <!-- Header -->
                   <div class="modal-header bg-primary pb-4">
                       <h5 class="modal-title text-white" id="modalEditHistorialEditLabel">Editar documentos</h5>
                       <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                   </div>
                       ...
                       <form id="formEditHistorialEdit" enctype="multipart/form-data">
                           ...
                           <div class="card-body">
                               <div class="row g-3">
                                   ...
                                   <div class="col-md-6">
                                       <div class="form-floating form-floating-outline">
                                           <select name="id_procedimiento" id="edit_edit_id_procedimiento" class="select2 form-select">
                                               <option value="">Seleccione un procedimiento</option>
                                               @foreach ($procedimientos as $procedimiento)
                                                   <option value="{{ $procedimiento->id_doc_calidad }}">
                                                       {{ $procedimiento->identificacion }} -
