<div class="modal fade" id="editPedidoExportacion" tabindex="-1">
  <div class="modal-dialog modal-xl modal-simple modal-edit-new-export">
          ...
          <div class="modal-body p-0">
              ...
              <form id="editPedidoExportacionForm">
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-floating form-floating-outline mb-6">
                              <select id="edit_tipo_solicitud" class="form-select" name="tipo_solicitud">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8">
                          <div class="form-floating form-floating-outline mb-5">
                              <select class="select2 form-select" id="edit_id_instalacion_exportacion"
                  ...
                  <div class="card" id="pedidos_Ex">
                      <div class="card-body">
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-floating form-floating-outline mb-4">
                                      <select class="form-select select2" name="direccion_destinatario"
                                          id="edit_direccion_destinatario_ex">
                              ...
                              <div class="col-md-6">
                                  <div class="form-floating form-floating-outline mb-4">
                                      <input type="file" class="form-control" id="edit_factura_proforma"
                              ...
                              <div class="col-md-6">
                                  <div class="form-floating form-floating-outline mb-4">
                                      <input type="file" class="form-control" id="edit_factura_proforma_cont"
                  ...
                  <div id="sections-container">
                      ...
                      <div class="card mt-4" id="edit_caracteristicas_Ex">
                          <div class="card-body">
...
<script>
  ...
  function editcargarInstalaciones(instalaciones) {
      if (instalaciones !== "" && instalaciones !== null && instalaciones !== undefined) {
          ...
          $('#edit_id_instalacion_exportacion').html(contenidoInstalaciones);
      }
  }
  ...
  function editcargarInstalacionesEnvasado(instalaciones) {
      if (instalaciones !== "" && instalaciones !== null && instalaciones !== undefined) {
          ...
          $('#edit_id_instalacion_envasado').html(contenidoInstalaciones);
      }
  }
  ...
  function editcargarDirecciones(direcciones) {
      if (direcciones !== "" && direcciones !== null && direcciones !== undefined) {
          ...
          $('#edit_direccion_destinatario_ex').html(contenidoDirecciones);
          //cargarMarcas();
      }
  }
