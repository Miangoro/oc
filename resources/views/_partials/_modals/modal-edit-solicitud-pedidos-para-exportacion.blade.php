                    ...
                    <div class="card" id="pedidos_Ex">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating form-floating-outline mb-4">
                                        <input type="text" class="form-control aduana_salida" name="aduana_salida"
                ...
                if (response.detalle && response.detalle.length > 0) {
                    ...
                    response.detalle.forEach((lote, index) => {
                        let filaGranel = `
                            <tr>
                                <td>${index + 2}</td>
                                <td>${lote.nombre_lote}<br><b>Certificado: </b>${lote.certificado_granel.num_certificado || 'Sin definir' }</td>
