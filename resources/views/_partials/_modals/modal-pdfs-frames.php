  ...
  <div class="modal-dialog modal-xl modal-simple">
    <div class="modal-content">
      <div class="modal-header d-flex justify-content-between">
        <h5 class="modal-title" id="titulo_modal_Dictamen1" style="flex: 1; text-align: center;"></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        <a id="openPdfBtnDictamen1" href="#" target="_blank" class="btn btn-primary ms-3" style="display: none;">Abrir PDF en nueva pestaña</a>
      </div>
      <div class="modal-body p-0 d-flex flex-column justify-content-center align-items-center">
        <div class="text-center mb-6">
