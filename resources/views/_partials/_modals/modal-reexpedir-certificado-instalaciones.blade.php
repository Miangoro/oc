...
<div class="modal fade" id="modalReexpedirCertificadoInstalaciones" tabindex="-1" aria-labelledby="modalReexpedirCertificadoInstalacionesLabel" aria-hidden="true">
    <div class="modal-dialog modal-lz">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="modalReexpedirCertificadoInstalacionesLabel" class="modal-title">Reexpedir Certificado de Instalaciones</h5>
                ...
                <form id="addReexpedirCertificadoInstalacionesForm" method="POST" action="{{ route('certificados.reexpedir') }}">
                    ...
                    <div id="campos_condicionales" style="display: none;">
                        ...
                        <div class="form-floating form-floating-outline mb-3">
                            <select class="select2 form-select" id="id_dictamen_rex" name="id_dictamen" aria-label="No. Dictamen">
