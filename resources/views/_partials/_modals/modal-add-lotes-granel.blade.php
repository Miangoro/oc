            ...
            <div class="modal-body">
                ...
                <form id="loteForm" method="POST" action="{{ route('lotes-register.store') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="number" step="0.01" id="volumen" name="volumen" class="form-control"
                                    ...
                                    data-error-message="Por favor selecciona el volumen" />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="number" step="0.01" id="cont_alc" name="cont_alc" class="form-control"
                            ...
                            <div class="form-floating form-floating-outline mb-4">
                                <select id="id_categoria" name="id_categoria" class=" form-select">
                                    <option value="" disabled selected
                                        data-error-message="Por favor seleccione una categoria">Selecciona la categoría
                                        de agave
                                    </option>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="fecha_vigencia" name="fecha_vigencia"
                                        class="form-control datepicker" placeholder="Fecha de Vigencia" readonly />
