...
<body>
  ...
  <div class="encabezado"> <img src="{{ public_path('img_pdf/logo_oc_3d.png') }}"
    ...
    <p class="text">
      ...
      dentro de los estados y municipios que contempla la Resolución mediante la cual se otorga la protección prevista a
      la Denominación de Origen Mezcal, para ser aplicada a la bebida alcohólica del mismo nombre, publicada el 28 de
      Noviembre de 1994, así como sus subsecuentes modificaciones, son descritas a continuación:
    </p>
    ...
    <table>
      <tbody>
        <tr>
          <td class="td-margins"
            style="width: 243px; font-weight: bold; font-size: 12px; padding-right: 4px; padding-left: 1px; padding-top: 5px; padding-bottom: 5px;">
            <strong>Maestro mezcalero:</strong>
          </td>
          <td class="td-margins"
            style="text-align: left; padding-left: 12px; margin-left: 5px; padding-top: 5px; padding-bottom: 5px;">
            {{ $maestro_mezcalero }}
          </td>
        </tr>
        <tr>
          <td class="td-margins"
            style="font-weight: bold; font-size: 12px;padding-right: 4px;padding-left: 1px;padding-top: 5px;padding-bottom: 5px;">
            <strong>Domicilio de producción:</strong>
          </td>
          <td class="td-margins"
            style="text-align: left; padding-left: 12px; margin-left: 5px; padding-top: 5px; padding-bottom: 5px;">
            {{ $direccion_completa }}
        ...
        <tr>
          <td class="td-margins"
            style="font-weight: bold; font-size: 12px;padding-right: 4px;padding-left: 1px;padding-top: 5px;padding-bottom: 5px;">
            <strong>No. de autorización para el Uso de la Denominación de Origen Mezcal:</strong>
          </td>
          <td class="td-margins"
            style="text-align: left; padding-left: 12px; margin-left: 5px; padding-top: 5px; padding-bottom: 5px;">
            {{ $num_autorizacion }}
    ...
    <div class="footer">
      <p style="text-align: right; font-size: 9px; line-height: 1; margin-bottom: -1.75px;">
        @if ($id_sustituye)
