...
<body>
    ...
    <div class="contenido">
        <div class="title">No.:UMC-100/2025</div>

        <div class="title"> Dictamen de cumplimiento de Instalaciones </div>
        <div class="subtitulos">como</div>

        <div class="title2">Envasador de Mezcal</div>
        <div class="text">
        ...
        <p class="text">
            El presente dictamen ampara exclusivamente el envasado del producto mezcal que se realiza en las
            instalaciones
            referidas en el presente documento. Dichas Instalaciones de envasado cuentan con la infraestructura y
            equipamiento
            requerido para el envasado demezcal indicados en la NOM-070-SCFI-2016, Bebidas alcohólicas-Mezcal
            Especificaciones
        </p>
        <p class="text">
            Las instalaciones se encuentran en región de los estados y municipios que contempla la resolución mediante el cual
            se otorga la protección prevista a la denominación de origen Mezcal,para ser aplicada a la bebida alcohólica del
            mismo nombre, publicada el 28 de noviembre de 1994, así como sus modificaciones subsecuentes.
        </p>
        <br>
        <div>
            <p class="textx">
