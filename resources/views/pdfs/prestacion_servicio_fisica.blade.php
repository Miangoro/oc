 ...
 */
        ...
        ul.custom-list {
            ...
            /* Coloca la viñeta dentro del contenido de la lista */
            padding-left: 0;
        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <tr>
                            <td>
                                <p class="bold">CONTRATO DE PRESTACIÓN DE SERVICIOS QUE
                                    ...
                                    EL C. <u>{{ mb_strtoupper($datos[0]->razon_social) ?? '' }}
                                    </u> Y A QUIEN EN LO SUCESIVO SE LE
                                ...
                                <br>
                                Con fecha del día 31 de enero de 2017 la Universidad Michoacana de San Nicolás de
                                Hidalgo recibió la acreditación
                                indefinida de parte de la Entidad Mexicana de Acreditación, Asociación Civil
                                (en lo conducente <strong>EMA, A.C.</strong>) bajo la norma NMX-EC-17020-IMNC-2014
                                ISO/IEC17020:2012.
                                Requisitos para el funcionamiento de diferentes tipos de unidades (organismos) que
                                realizan la verificación (inspección), para la materia de Producto con numero de
                                Acreditación Número:
                                UVNOM 129, Número de referencia: 17UV2010 y con fecha de actualización: 2017/07/10, y
                                con aprobación
                                por la Dirección General de Normas en su oficio: DGN.312.01.2019.1446 de fecha 06 de
                                mayo de 2019
                                de manera indefinida mientras se mantenga la
                            </td>

                            <td>
                                <p>acreditación No. UVNOM 145 otorgada por la EMA, A.C. con alcance a la
                                    NOM-070-SCFI-2016,
                                    Bebidas alcohólicas-Mezcal-NOM-070-SCFI-2016, Especificaciones. Por otro lado, la
                                    Universidad
                                    Michoacana de San Nicolás de Hidalgo es Asociado Propietario del <strong>“CIDAM,
                                        A.C.”</strong> según se establece
                                    en la escritura pública número 2,551, volumen 73, de fecha 11 de enero del año 2012.
                                    Además,
                                    se tiene firmado un contrato de colaboración vigente para operar la Unidad de
                                    verificación
                                    UVEM NOM 129 de la UMSNH en las Instalaciones del CIDAM. <strong>“EL CIDAM,
                                        A.C.”</strong> solicitará
                                    a la Unidad de Verificación de la UMSNH el servicio de Verificación cada vez que lo
                                    requiera.
                                    <br>
                                    <br>
                                    <strong>“EL CIDAM, A.C.”</strong>, cuenta con la acreditación por la EMA, A.C. bajo
                                    la norma
                                    NMX-EC-17065-IMNC-2014 ISO/IEC 17065:2012. Evaluación de la conformidad - requisitos
                                    para organismos que certifican productos, procesos y servicios, para el programa de
                                    Productos,
                                    con la Acreditación Número: 144/18 de fecha 2018/12/06 y con Fecha de actualización:
                                    2019/05/16,
                                    y aprobados por la DGN en su oficio: Of. No. DGN.312.01.2018.3927 de fecha 11 de
                                    diciembre de 2018
                                    con la autorización de forma indefinida mientras se mantenga la Acreditación Número:
                ...
                <p style="text-align: center; margin-top: 10px; font-size: 10.5px;">
                    Este documento es propiedad del Centro de Innovación y Desarrollo Agroalimentario de Michoacán A.C.
                    y no
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>
                                    ...
                                    es: <strong style="color: red;">XXXXXX.</strong>
                                </p>
                                <p></p>
                                <p></p>
                                <p>
                                ...
                                <p></p>
                                <p>
                                    <strong>III.I </strong>Que reconocen mutuamente su personalidad y capacidad legal
                                    para
            ...
            <div class="col-md-12">
                <table class="table">
                    <tbody>
                        <tr>
                            <td class="small-column">
                                <p>f) <strong>“El CLIENTE”</strong> se compromete a adquirir y/o utilizar materia prima
                                    permitida por la normativa aplicable.</p>
                                <p>g) Dar las facilidades para que se realicen las evaluaciones y vigilancias, estar
                                    disponibles para la verificación la documentación, registros, equipos, áreas,
                                    personal y subcontratistas que sean pertinentes.</p>
                                <p>h) Atender los incumplimientos marcados por <strong>“EL CIDAM, A.C.”</strong> y dar
                                    facilidades para investigar las quejas interpuestas por las partes interesadas.</p>
                                <p>i) Permitir la participación de observadores durante las evaluaciones si fuera
                                    necesario.</p>
                                <p>j) En caso de emitir alguna declaración sobre la certificación, será coherente con su
                                    alcance certificado.</p>
                                <p>k) No utilizar la certificación otorgada de manera que ocasione mala reputación para
                                    <strong>“EL CIDAM, A.C.”</strong> y a no utilizar declaraciones que puedan
                                    determinarse engañosas o no autorizadas.</p>
                                <p>l) <strong>“El CLIENTE”</strong> se compromete a cumplir con el Instructivo para el
                                    uso de certificados y marcas I4.1-01-01, así como el Manual de identidad corporativa
                                    del OC CIDAM F4.1-01-02, los cuales serán enviados por personal del Organismo
                                    Certificador “OC” por lo cual se le pide firmar el formato que se encuentra anexa a
                                    éste contrato para confirmar de enterado. En caso de no cumplir con lo estipulado en
                                    esta cláusula</p>
                            </td>
                            <td>
                                <p>se procederá a denegar o cancelar la certificación.</p>
                                <p>m) Inmediatamente después de retirar, suspender o finalizar la certificación dejar de
                                    utilizar toda publicidad que haga referencia a la certificación otorgada por
                                    <strong>“EL CIDAM, A.C.”.</strong></p>
                                <p>n) Si <strong>“EL CLIENTE”</strong> suministra copias de los documentos de
                                    certificación a otros, los documentos se deben reproducir en su totalidad, no de
                                    manera parcial, con el fin de mantener la estructura original de los documentos.</p>
                                <p>o) A hacer referencia a la certificación de producto en medios publicitarios
                                    únicamente cuando cumpla con los requisitos de <strong>“EL CIDAM, A.C.”</strong>
                                    relacionados al esquema de certificación.</p>
                                <p>p) Cumplir con los requisitos que establece el esquema de certificación con relación
                                    al uso de marcas de conformidad y a la información relacionada con el producto.</p>
                                <p>q) Cuando <strong>“EL CLIENTE”</strong> emita una queja y esta proceda, <strong>“EL
                                        CIDAM, A.C.”</strong>, enviará al reclamante una notificación formal sobre el
                                    resultado y la finalización del proceso de reclamación, <strong>“EL CIDAM,
                                        A.C.”</strong> debe proporcionar al apelante una notificación formal del
                                    resultado y la finalización del proceso de apelación, para que <strong>“EL
                                        CLIENTE”</strong> conozca el proceso de atención de quejas y apelaciones
                                    <strong>“EL CLIENTE”</strong> podrá revisar el documento PR-UGII-008 el cual puede
                                    solicitarlo a los</p>
                            </td>
                        </tr>
                    </tbody>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <br>
                                <strong>
                                    <p style="text-align: center;">POR "EL CLIENTE"</p>
                                </strong>
                                <br>
                                <br>
                                <br>
                                ...
                                <br>
                                <strong>
                                    <p style="text-align: center;">POR “EL CIDAM”</p>
                                </strong>
                                <br>
                                <br>
                                <br>
                                <strong>
                                    <p style="text-align: center;">MTRA. SYLVANA FIGUEROA SILVA</p>
                                </strong>
