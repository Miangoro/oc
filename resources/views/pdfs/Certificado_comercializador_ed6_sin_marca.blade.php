...
{{--     <div class="img-fondo"> <img src="{{ public_path('img_pdf/logo_fondo.png') }}" alt="Fondo CIDAM" class="watermark">
    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td class="td-margins" style="text-align: left;  padding-left: 6px; padding: 5px;">{{ $rfc }}
                </td>
            </tr>
            <tr>
                <td class="td-margins"
    ...
    <p class="text">
        ...
        ejecutar las etapas de comercialización de la Bebida Alcohólica Destilada Denominada Mezcal, de conformidad
        con
