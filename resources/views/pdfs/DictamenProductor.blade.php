...
<body>
    ...
    <table>
        <tbody>
            <tr>
                <td style="text-align: justify;"><strong>Número de cliente:</strong><br>(Otorgado por el Organismo Certificador del Centro de Innovación y Desarrollo Agroalimentario de Michoacán A.C.) (CIDAM)</td>
