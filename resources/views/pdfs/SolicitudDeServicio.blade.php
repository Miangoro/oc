...
<body>
    <table>
        <tr>
            ...
            <td rowspan="2" colspan="5" style="font-size: 12px">SOLICITUD DE SERVICIOS</td>
            <td class="sin-negrita" colspan="3" style="text-align: right">Solicitud de servicios NOM-070-SCFI-2016 F7.1-01-32 <br>
                Edición 10 Entrada en vigor:
                20/06/2024</td>
        </tr>
        <tr>
            <td class="sin-negrita" colspan="3">
    ...
    <table>
        ...
        <tr>
            <td class="td-no-margins sin-negrita" colspan="9" style="padding-top: 550px">Este documento es propiedad del Centro de Innovación y Desarroll
                Agroalimentario de Michoacán A.C.</td>
        </tr>
        <tr>
            <td class="td-no-margins">&nbsp;</td>
    ...
    <table>
        <tr>
            <td class="td-no-margins sin-negrita" colspan="9"  style="padding-top: 790px">Este documento es propiedad del Centro de Innovación y Desarroll
                Agroalimentario de Michoacán A.C.</td>
        </tr>
        <tr>
            <td class="td-no-margins">&nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td class="sin-negrita" colspan="7">Copia del análisis de laboratorio de cada uno de los lotes en cumplimiento con el
        ...
        <tr>
            <td class="sin-negrita" colspan="4">Se cuenta con todos los medios para realizar todas las actividades de evaluación para la <br>
                Certificación:</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td class="sin-negrita" colspan="4">El organismo de Certificación tiene la competencia para realizar la Certificación</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="sin-negrita" colspan="4">El organismo de Certificación tiene la capacidad para llevar a cabo las actividades de <br>
                certificación</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
    ...
    <table>        <tr>
        <td class="td-no-margins sin-negrita" colspan="9"  style="padding-top: 400px">Este documento es propiedad del Centro de Innovación y Desarroll
            Agroalimentario de Michoacán A.C.</td>
    </tr>
    <tr>
        <td class="td-no-margins">&nbsp;</td>
