...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-text"><p style=" margin: 0;">Orden de trabajo de inspección de etiquetas R-UNIIC-004</p>
                 <p style=" margin: 0;">Edición 1, 19/08/2024</p></div>
            <div class="line"></div>
        </div>        
        <p class="text">
        ...
        <table class="mi-tabla">
            ...
            <tr>
                ...
                <td style="text-align: left;">Café instantaneo, sabor cappuccino original, mokaccino, cappuccino crema irlandesa, cappuccino a la
        ...
        <br>
        <p>Para esta deligencia debe presentarse en las intalaciones referidas acontinuación y llenar el Acta de Verificación y los registros correspondientes a la actividad a realizar:</p>
        ...
        <table class="firma-section">
            <tr>
                ...
                <td>
                    ...
                    <div class="firma-linea"></div>
                    <div class="firma-texto">Gerente Técnico de la Unidad De Inspección de Información Comercial del CIDAM A.C.</div>
                </td>
            </tr>
        </table>
        <br>
            <p class="tex-center">
                Este documento es propiedad del Centro de Innovación y Desarrollo Agroalimentario de Michoacán A.C. y no puede ser distribuido externamente sin la autorización escrita del Ejecutivo.
            </p>
        </div>
