...
table {
    ...
    width: 100%;
    position: fixed;
    bottom: -50px; /* Siempre en la parte inferior */
    left: 0; /* Asegura que quede alineado con el borde izquierdo */
    font-size: 12px;
    display: flex;
...
<body>
    ...
    <table class="etiqueta-table">
      <tbody>
              <tr>
                  <td rowspan="3" class="border-green-custom" style="width: 100px;"><img src="{{ public_path('img_pdf/UVEM_logo.png') }}" alt="Unidad de Inspección" class="logo-small"></td>
              ...
              <tr>
                  ...
                  <td colspan="3" class="white-background-custom"><strong>MEZCAL ARTESANAL - BLANCO O JOVEN</strong></td>
                  <td colspan="2" class="custom-title">Especie de agave: </td>
                  <td colspan="2" class="white-background-custom" style="font-size: 8px;"><strong>Maguey Espadín (A. angustifolia)</strong></td>
              </tr>
              <tr>
                ...
                <td  class="white-background-custom" style="font-size: 9px;"><strong>003-AMB, 001-AMG Y 005-AMB</strong></td>
              ...
              <tr>
                  ...
                  <td colspan="3" class="white-background-custom" style="font-size:11px;"><strong>Rey Marcelo Gandarilla Bailon</strong></td>
                  <td colspan="2" class="custom-title" style="font-size:11px; text-align: left;">Nombre y firma del responsable:</td>
                  <td colspan="2" class="white-background-custom" style="font-size: 11px;"><strong>Juan Carlos López Hernández</strong></td>
              </tr>
          </tbody>
      </table>
{{-- segunda tabla --}}
     ...
     <table class="etiqueta-table">
      <tbody>
        ...
        <div class="footer-right">
            <p>Entrada en vigor el 15 de julio del 2024 <br>
              Página 1 /1 F-UV-04-04 Versión 16</p>
        </div>
    </div>
</body>
</html>
