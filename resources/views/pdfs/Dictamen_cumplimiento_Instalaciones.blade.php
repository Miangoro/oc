...
<div class="container">
    ...
    <div class="text">
        ...
        <p>Después de realizar la inspección de las instalaciones en fecha del <span class="negrita"><u>{{ $fecha_inspeccion }}</u></span> partiendo del acta
    ...
    <table class="interlineado">
        <tbody>
            ...
            <tr>
                <td class="negrita">Fecha de vigencia del dictamen: <br>&nbsp;</td>
