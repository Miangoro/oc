    ...
    <div class="card">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
            <div class="offcanvas-header border-bottom">
                <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Nueva Imagen</h5>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="editClase">
            <div class="offcanvas-header border-bottom">
                <h5 class="offcanvas-title">Editar Imagen</h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body mx-0 flex-grow-0 h-100">
                @csrf
                <form class="edit-class-form pt-0" id="editImageForm" method="POST">
                    @csrf
                    <input type="hidden" name="imagen" id="edit_imagen_id" value="">
                    <div class="form-floating form-floating-outline mb-5">
                        <input type="text" class="form-control" id="edit_imagen_nombre" placeholder="Nombre de la imagen"
                            name="nombre" required>
                        <label for="edit_imagen_nombre">Nombre de la imagen</label>
                    </div>
