                                ...
                                <div class="col-md">
                                    <div class="form-check custom-option custom-option-icon">
                                        <label class="form-check-label custom-option-content" for="customRadioIcon32">
                                            ...
                                            <input class="form-check-input" type="checkbox" id="customRadioIcon32" value="7" />
                                        </label>
                                    </div>
                                ...
                                <div class="col-md">
                                    <div class="form-check custom-option custom-option-icon">
                                        <label class="form-check-label custom-option-content" for="customRadioIcon52">
                                            ...
                                            <input class="form-check-input" type="checkbox" id="customRadioIcon52" value="27"/>
                                        </label>
                                    </div>
