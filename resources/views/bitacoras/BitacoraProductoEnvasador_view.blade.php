...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header pb-0 mb-1">
            <h3 class="card-title mb-0">Inventario de producto terminado (Envasador)</h3>
        </div>
    ...
    @include('_partials/_modals/modal-add-bitacoraProductoEnvasador')
    @include('_partials._modals.modal-edit-bitacoraProductoEnvasador')
