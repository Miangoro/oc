...
class LotesGranel extends Model
{
    ...
    protected $fillable = [
        'id_empresa','id_empresa_destino', 'id_tanque', 'nombre_lote', 'id_instalacion','tipo_lote', 'folio_fq', 'volumen', 'volumen_restante', 'volumen_sin_agua',
   ...
   public function gettiposRelacionadosAttribute()
{
    ...
    {
        return $this->hasOne(CertificadosGranel::class, 'id_lote_granel', 'id_lote_granel')->where('estatus','!=',1);
    }
