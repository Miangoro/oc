...
class clientesConfirmadosController extends Controller
{
    public function UserManagement()
    {
        ...
        $morales = empresa::where('tipo', 2)->where('regimen', 'Persona morales')->count();
    ...
    public function index(Request $request)
    {
        ...
        if (empty($request->input('search.value'))) {
            ...
            ->select('empresa.razon_social','empresa.id_empresa','empresa.rfc','empresa.domicilio_fiscal','empresa.representante','empresa.regimen' , DB::raw('GROUP_CONCAT(n.numero_cliente SEPARATOR "<br>") as numero_cliente'))
