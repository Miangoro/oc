...
/*             if (Auth::check() && Auth::user()->tipo == 3) {
      ...
      $instalacionesUsuario = instalaciones::whereIn('id_instalacion', $instalacionesIds)->get();
        return view('bitacoras.BitacoraHologramas_view', compact('bitacora', 'empresas', 'tipo_usuario', 'instalacionesIds','instalacionesUsuario'));
    }
    ...
    public function index(Request $request)
    {
      ...
      DB::statement("SET lc_time_names = 'es_ES'");//Forzar idioma español para meses
        ...
        $query = BitacoraHologramas::query()->where('tipo', 2);
              ...
              $filteredQuery->where(function ($q) use ($search) {
                  ...
                  if ($lower === 'firmado') {
                    ...
                    $q->where('fecha', 'LIKE', "%{$search}%")
                      ...
                      ->orWhere('serie_merma', 'LIKE', "%{$search}%")
          ...
          $razonSocial = $bitacora->empresaBitacora->razon_social ?? 'Sin razón social';
           $numeroCliente = null;
            ...
            $nestedData = [
               ...
               /*  'num_sellos_mermas' => $bitacora->num_sellos_mermas ?? 'N/A', */
