...
class RevisionConsejoController extends Controller
{
    ...
    public function edit_revision_consejo($id_revision)
    {
        ...
        $preguntasQuery = preguntas_revision::where('tipo_revisor', 2)->where('tipo_certificado', $datos->tipo_certificado)->where('orden', $datos->numero_revision == 1 ? 0 : 1);
    ...
    public function editar_revision_consejo(Request $request)
{
    ...
    public function pdf_bitacora_revision_certificado_exportacion($id)
    {
     ...
     public function pdf_bitacora_revision_certificado_venta_nacional($id)
    {
        $revisor = Revisor::findOrFail($id);
        ...
        $pdfData = [
            ...
            $pdf = Pdf::loadView('pdfs.pdf_bitacora_de_revisión_de_certificado_venta_nacional',$pdfData)
            ->setPaper('letter'); // Define tamaño carta
