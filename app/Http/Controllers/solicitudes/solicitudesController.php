...
class solicitudesController extends Controller
{
    public function UserManagement()
    {
       ...
       // FILTRO DE EMPRESAS SEGÚN EL USUARIO
        ...
        return view('solicitudes.find_solicitudes_view', compact('tipo_usuario','instalaciones', 'empresas', 'estados', 'inspectores', 'solicitudesTipos', 'organismos', 'LotesGranel', 'categorias', 'clases', 'tipos', 'marcas'));
    }
