        ...
        if ($users->isNotEmpty()) {
            ...
            foreach ($users as $user) {
                ...
                $nestedData = [
                    ...
                    'folio_inicial' => '<a target="_Blank" href="http://localhost:8000/pages/hologramas-validacion/'.$numero_cliente.$user->marcas->folio.'-'.str_pad($user->folio_inicial, 6, '0', STR_PAD_LEFT).'">'.$numero_cliente.$user->marcas->folio.'-'.str_pad($user->folio_inicial, 6, '0', STR_PAD_LEFT).'</a>',
                    'folio_final' => '<a target="_Blank" href="http://localhost:8000/pages/hologramas-validacion/'.$numero_cliente.$user->marcas->folio.'-'.str_pad($user->folio_final, 6, '0', STR_PAD_LEFT).'">'.$numero_cliente.$user->marcas->folio.'-'.str_pad($user->folio_inicial, 6, '0', STR_PAD_LEFT).'</a>',
