...
public function getVolumenLoteBitacoraM($id_lote_granel)
{

    $ultimaBitacora = \App\Models\BitacoraProductoMaduracion::where('id_lote_granel', $id_lote_granel)
        ->orderByDesc('id')
        ->first();
...
$numero_cliente_granel = $numero_cliente;
