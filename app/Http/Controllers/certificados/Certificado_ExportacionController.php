        ...
        $query->orderByRaw("
            ...
            CAST(
                SUBSTRING_INDEX(
                    SUBSTRING(
                        num_certificado,
                        LOCATE('CIDAM C-EXP', num_certificado) + 11,
                        LOCATE('-', SUBSTRING(num_certificado, LOCATE('CIDAM C-EXP', num_certificado) + 11)) - 1
                    ),
                    '-', 1
                ) AS UNSIGNED
            ) DESC,
            CAST(
                SUBSTRING_INDEX(num_certificado, '-', -1) AS UNSIGNED
            ) $orderDirection
        ");
