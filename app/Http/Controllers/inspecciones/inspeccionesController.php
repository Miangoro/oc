...
class inspeccionesController extends Controller
{
    ...
    public function editActa($id_acta)
    {
        try {
            ...
            $acta = actas_inspeccion::with('actas_testigo', 'acta_produccion_mezcal', 'actas_equipo_mezcal', 'actas_unidad_envasado', 'actas_unidad_comercializacion')->findOrFail($id_acta);
