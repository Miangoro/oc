    ...
    public function store(Request $request)
{
    ...
    public function acta_circunstanciada_produccion($id_inspeccion)
    {
        ...
        'actas_inspeccion.actas_equipo_envasado', 'actas_inspeccion.actas_unidad_comercializacion', 'actas_inspeccion.actas_unidad_envasado','actas_inspeccion.actas_produccion.predio_plantacion')->find($id_inspeccion);
        $fecha_llenado = Helpers::formatearFecha($datos->actas_inspeccion->fecha_fin);
       $hora_llenado = Helpers::extraerHora($datos->actas_inspeccion->fecha_fin);
        $pdf = Pdf::loadView('pdfs.acta_circunstanciada_unidades_produccion', compact('datos','hora_llenado', 'fecha_llenado'));
